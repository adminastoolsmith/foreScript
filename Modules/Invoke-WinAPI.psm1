# -----------------------------------------------------------------------------------------
# Script: Invoke-WinAPI.psm1
# Author: Nigel Thomas
# Date: April 24, 2015
# Version: 1.0
# Purpose: This script provides access to the Windows API via P/Invoke.
#
# Project: foreScript
#
# -----------------------------------------------------------------------------------------
...
# Set  to read only
#Set-Item -Path variable:Login_Impersonation -Options ReadOnly
#Set-Item -Path variable:DHCP_EnumSubnetClients -Options ReadOnly
#Set-Item -Path variable:DHCP_Structs -Options ReadOnly


# Export
Export-ModuleMember -Variable Login_Impersonation
